...
impl HomeAssistantContainer {
    ...
    fn sensor(
        ...
        Sensor {
            ...
            name: name.into(),
            default_entity_id: Some(format!("sensor.{}", self.object_id(suffix))),
    ...
    fn button(
        ...
        Button {
            ...
            icon: icon.map(Into::into),
            name: name.into(),
            default_entity_id: Some(format!("button.{}", self.object_id(suffix))),
            object_id: Some(self.object_id(suffix)),
            payload_available: None,
            payload_not_available: None,
...
mod test {
    ...
    fn assert_sensor(
        ...
        let expected_entity_id = format!("sensor.{}", object_id);
        assert_eq!(
    ...
    fn assert_button(
        ...
        let expected_entity_id = format!("button.{}", object_id);
        assert_eq!(
